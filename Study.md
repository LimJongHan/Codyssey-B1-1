...
5. [방화벽(UFW) — 보안 경비원](#5-방화벽ufw--보안-경비원)
6. [계정과 그룹 — 회사의 사원증과 부서](#6-계정과-그룹--회사의-사원증과-부서)
7. [파일 권한과 ACL — 자물쇠와 마스터키](#7-파일-권한과-acl--자물쇠와-마스터키)
8. [환경 변수 — 프로그램의 설정값](#8-환경-변수--프로그램의-설정값)
9. [프로세스 — 실행 중인 프로그램](#9-프로세스--실행-중인-프로그램)
10. [Bash 스크립트 — 자동화의 기본](#10-bash-스크립트--자동화의-기본)
11. [로그(Log) — 서버의 블랙박스](#11-로그log--서버의-블랙박스)
12. [crontab — 알람처럼 반복 실행](#12-crontab--알람처럼-반복-실행)
13. [monitor.sh 해부 — 코드 한 줄씩 이해하기](#13-monitorsh-해부--코드-한-줄씩-이해하기)
14. [Docker — 가상 컴퓨터 속 컴퓨터](#14-docker--가상-컴퓨터-속-컴퓨터)
15. [전체 흐름 정리](#15-전체-흐름-정리)
