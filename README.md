...
└── images/           # 수행내역서 증거 캡처 이미지
    ...
    ├── 05_acl.png                 # ACL 확인 (upload_files / api_keys / log)
    ├── 06_bashrc.png              # 환경 변수 .bashrc 확인
    ├── 07_keyfile.png             # 키 파일 내용 및 권한 확인
    ├── 08_boot_sequence.png       # Boot Sequence 및 포트 리슨 확인
    ├── 09_monitor_permission.png  # monitor.sh 권한 확인
    ├── 10_monitor_run.png         # monitor.sh 수동 실행 결과
    ├── 11_crontab.png             # crontab 등록 확인
    ├── 12_monitor_log.png         # monitor.log 자동 누적 확인
    ├── 13_report_full.png         # report.sh 전체 실행 결과
    ├── 14_report_range.png        # report.sh 구간 필터 실행 결과
    └── 15_archive.png             # archive.sh 실행 결과
```
